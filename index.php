<html>
    ...
    <body>
        ...
        <section id="bg-section" class="parallax" data-image="img/reservation-img.jpg"  data-height="1600">
            <div class="centered-caption-label">
                <img class="centered-caption-label" src="img/reservation-caption.png"></img>
            </div>	
        </section>
        <div>
            <div class="scroll-me" onClick="scroll('#footer', '#slides')">
                <span class="arrow">
                </span>
            </div> 
            <section id="separator-section">
        ...
        <section id="bg-section" class="parallax" data-image="img/lodging-image.jpg"  data-height="1600">
            <div class="centered-caption-label">
                <img class="centered-caption-label" src="img/logding-caption.png"></img>
            </div>
        </section>
        <div>
            <div class="scroll-me" onClick="scroll('#footer', '#slides')">
        ...
        <section id="bg-section" class="parallax" data-image="img/fishing-image.jpg"  data-height="1600">
            <div class="centered-caption-label">
                <img class="centered-caption-label" src="img/fishing-caption.png"></img>
            </div>
        </section>
        <div>
            <div class="scroll-me" onClick="scroll('#footer', '#slides')">
